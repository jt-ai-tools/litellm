<h1 align="center">
    ...
    <p align="center">
        <p align="center">基準測試 LLM 的回應、成本和回應時間</p>
        <p>LLM vs 每個輸入 + 輸出權杖的成本 ($)</p>
...
### 設定
在 `benchmark/benchmark.py` 中選擇您的 LLM、LLM API 金鑰和問題
...
## 支援 
**🤝 預約 1 對 1 工作階段：** 預約與創辦人 Krrish 和 Ishaan 的 [1 對 1 工作階段](https://calendly.com/d/cx9p-5yf-2nm/litellm-introductions)，討論任何問題、提供回饋，或探索我們如何為您改進 LiteLLM。
